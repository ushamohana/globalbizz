						...
						field = {
							...
							items : [
								...
								{ type : 'button', text : field.text, onclick : function(){
									...
									Themify_Icons_.target = $this.prev(); // set the input text box that recieves the value
									Themify_Icons_.showLightbox( Themify_Icons_.target.val() ); // show the icon picker lightbox
								} }
							]
						};
					}
